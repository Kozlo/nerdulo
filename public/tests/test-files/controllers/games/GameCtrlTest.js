(function() {
    ...
    module("Game Controller", {
        setup: function () {
            var injector = angular.injector(['ng', 'GameCtrl', 'AllStarService']);
            ...
            this.oCtrl = $controller('GameController',{
            ...
            this.oCtrl._startGame(aTestQuests);
        },
        teardown: function () {
    ...
    test("Test to see if the controller exists and the correct route is used", function() {
        ok(this.oCtrl, 'The Game controller exists');
    ...
    test("Does startGame instantiates questions and creates the correct properties", function() {
        ...
        deepEqual(aQuests, aTestQuests, "Questions property assigned properly");
